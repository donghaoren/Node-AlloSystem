...
function buildTextureArray() {
    if(vertex_array == null) {
        ...
        var slices = 30;
        var idx = 0;
        var array_data = new Float32Array(slices * slices * 4);
        ...
        GL.bufferData(GL.ARRAY_BUFFER, 4 * array_data.length, new Buffer(array_data), GL.STATIC_DRAW);
        console.log("bufferdata done");
...
allosphere.onDraw(function(info) {
    ...
    console.log("2", vertex_array);
    console.log(GL.getError());
    //console.log(GL.NORMAL_ARRAY, GL.TEXTURE_COORD_ARRAY, GL.COLOR_ARRAY, GL.INDEX_ARRAY);
    ...
    GL.vertexPointer(4, GL.FLOAT, 0, null);
